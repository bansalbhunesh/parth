...
3. **Open, reproducible eval + benchmark result.** A public test harness, 832
   backend tests, 43 frontend tests, 130 browser journeys, and a frozen **53-pair / 129-label / 17-system** benchmark with
