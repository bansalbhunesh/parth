...
# 2. Run the 308-test suite (no API key needed)
...
> **No API key?** The dashboard runs fully with ground-truth fallback data. All 22 API endpoints return 200. Both eval harnesses (structured + text-based), the corpus, and the frontend work offline. 308 tests pass without any external dependencies.
>
...
**40+ source files · 7,300+ lines of code · 308 tests · 12 projects · 22 endpoints**
