# ASHRAE TC 9.9 — Thermal Guidelines for Data Processing Environments (paraphrased summary)

ASHRAE Technical Committee 9.9 publishes thermal guidelines that define allowable and recommended environmental conditions at the server inlet, classified by equipment class.
...
For most data centre designs, the Class A1 recommended envelope is the design target:
- Supply air temperature: 18-27 C (target 24 C +/- 2 C)
- Dew point: -9 C to 15 C
- Relative humidity: <= 60% (may extend to 70% if data hall has verified low concentrations of pollutant gases)
- Allowable envelope defines manufacturer warranty conditions; recommended envelope targets optimal long-term reliability

## Rate of change
- Maximum allowable rate of temperature change: 5 C per hour during planned or unplanned transitions (e.g., cooling failover)
- Rapid temperature changes increase risk of condensation and thermal shock to components

## Measurement guidance
- Temperature and humidity shall be measured at the server inlet (front of rack), not at room average or return air
- Sensor placement: top, middle, and bottom of each rack or per hot-aisle/cold-aisle containment monitoring plan
- Altitude derating: maximum allowable temperature decreases by 1 C per 300 m above 900 m elevation


---

## Supplementary: ASHRAE-TC9.9_detailed
...
## Supplementary: ASHRAE-TC9.9_websearch_thermal_classes
