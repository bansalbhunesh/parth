# IS 1893 (Part 1): 2016 — Criteria for Earthquake Resistant Design of Structures (paraphrased summary)

IS 1893 is the Bureau of Indian Standards code for seismic design. It classifies India into seismic zones II through V (with Zone VI proposed in the 2025 draft amendment for the Himalayan belt).
...
*Navi Mumbai spans Zone III/IV boundary; critical infrastructure facilities shall assume Zone IV per IS 1893 clause 6.4.2.

## Design parameters for data centres
- Importance factor (I): 1.5 for critical infrastructure (post-disaster function, per Table 8)
- Response reduction factor (R): per structural system type
- Soil classification: Type I (rock/hard), Type II (medium), Type III (soft)
...
- Raised-floor pedestals: anchorage designed for applicable zone with importance factor I=1.5
- Equipment anchorage: server racks, UPS modules, switchgear, battery racks must be bolted/braced
- Suspended ceiling and cable tray bracing per IS 1893 Part 4
- Seismic isolation/damping for sensitive IT equipment if floor acceleration exceeds equipment rating

## Testing and qualification
- Shake-table testing or equivalent analysis for raised-floor systems in Zone IV and above
- Vendor to provide seismic qualification certificate for the applicable zone and importance factor


---

## Supplementary: IS-1893_detailed
...
## Supplementary: IS-1893_websearch_seismic_zones
