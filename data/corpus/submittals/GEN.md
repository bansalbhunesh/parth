# Vendor Submittal — Diesel Generators & Fuel Storage (GEN)
...
- **GEN-FUEL** — onsite fuel hours: **12 h** (vendor datasheet)
- **GEN-01** — redundancy: **N+1 topology** (vendor datasheet)
- **GEN-01** — rated power kva: **2500 kVA** (vendor datasheet)
- **GEN-01** — start time sec: **15 s** (vendor datasheet, includes warm-up cycle per manufacturer recommendation)
