...
STANDARDS = {
    ...
    "TIA-942": (
        ...
        "Rated-3: N+1 distribution paths (one active, one standby), "
        "concurrently maintainable.\n"
        "Rated-4: multiple independent active distribution paths, fault "
        "tolerant, allows one fault anywhere without downtime.\n\n"
    ...
    "NFPA-75": (
        ...
        "- FM-200 (HFC-227ea): most widely installed halocarbon agent, "
        "GWP 3500, atmospheric lifetime 33-36 years\n"
        "- Novec 1230 (FK-5-1-12): fluoroketone, GWP 1, atmospheric "
        "lifetime 0.014 years (5 days), zero ODP\n"
    ...
    "ASHRAE-TC9.9": (
        ...
        "- Relative humidity: <= 60% (may extend to 70% if data hall "
        "has verified low concentrations of pollutant gases)\n"
        "- Allowable envelope defines manufacturer warranty conditions; "
        "recommended envelope targets optimal long-term reliability\n\n"
        "## Rate of change\n"
