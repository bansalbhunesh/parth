...
const OG_IMAGE = {
  ...
  width: 1200,
  height: 630,
  alt: "Pramaan — catches the vendor deviation the day the submittal lands, and names the commissioning test it would have failed. Benchmark v1.2: recall 0.862, 0/64 false alerts, rule baseline 0.111, 666 tests.",
};
