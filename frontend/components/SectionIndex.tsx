...
const SECTIONS = [
  ...
  { id: "pipeline", num: "03", label: "Reasoning Pipeline", desc: "One LLM reasoning core + deterministic services in LangGraph", color: "#ffb020" },
  ...
  { id: "multiproject", num: "16", label: "Multi-Project Eval", desc: "12 projects, 11 countries, 50 seeded deviations (synthetic breadth)", color: "#a855f7" },
  { id: "eval", num: "17", label: "Eval Harness", desc: "Benchmark v1.2 + false-alert-rate testing", color: "#35c98b" },
